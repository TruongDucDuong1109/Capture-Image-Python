...
#             if ret:
#                 print("Received frame from camera.")  # In thông báo nếu nhận được khung hình từ camera
#                 qt_img = self.convert_cv_qt(cv_img)
#                 self.change_pixmap_signal.emit(qt_img)
#             else:
#                 print("Failed to receive frame from camera.")  # In thông báo nếu không nhận được khung hình từ camera
#                 # Đồng thời, bạn cũng có thể in thông báo lỗi chi tiết nếu cần
